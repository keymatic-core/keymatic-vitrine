...
export default function EcomCTA() {
  return (
    <section id="contato-ecom" className="section-padding relative" style={{ background: "linear-gradient(to bottom, #18181b, #27272a)" }}>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-[13px] text-zinc-300">
            <a
