          ...
          {CARDS.map((card, i) => {
            ...
            return (
              <motion.div
                ...
                className="group card-gradient-border p-6"
              >
                <div className="w-10 h-10 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center mb-4 transition-all duration-300 group-hover:border-orange-500/30 group-hover:shadow-[0_0_16px_rgba(249,115,22,0.12)]">
                  <Icon size={20} className="text-zinc-400 transition-colors duration-300 group-hover:text-zinc-200" />
                </div>
                <h3 className="text-base font-semibold text-white mb-1 transition-all duration-300 group-hover:text-lg">{card.title}</h3>
